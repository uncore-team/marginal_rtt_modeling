...
% Apart from that, the sample is guaranteed to satisfy SampleIsValid().
    ...
    elseif strcmp(mo.type,'BERN')
        error('Unimplemented bernoulli rnd');
    elseif strcmp(mo.type,'NORM')
        ds = NormRnd(mo.coeffs.mu,mo.coeffs.sigma,n,m);
    elseif strcmp(mo.type,'UNIF')
        ds = UnifRnd(mo.coeffs.a,mo.coeffs.b,n,m);
    else
